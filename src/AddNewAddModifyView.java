...
public class AddNewAddModifyView extends JDialog {
    ...
    public AddNewAddModifyView(MainView mainView) {
    ...
    protected void createAndShowGUI() throws IOException {
        ...
        this.fileNameSelected = mainView.getAddModifyView().selectedVcard;
        this.setCombo();
        ...
        saveInformation.setActionCommand("SAVEADDNEWADDMODIFYVIEW");
        leave.setActionCommand("LEAVEADDNEWADDMODIFYVIEW");
        reset.setActionCommand("RESETADDNEWADDMODIFYVIEW");
