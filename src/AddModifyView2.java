...
public class AddModifyView2 extends JDialog {
    protected JDialog jdialog;
    protected MainView mainView;

    protected JButton modifyProfil;
    protected JButton deleteProfil;
    ...
    public AddModifyView2(MainView mainView) {
        this.jdialog = this;
        ...
        this.modifyProfil = new JButton("MODIFY VCARD PROFIL");
        this.deleteProfil = new JButton("DELETE PROFIL VCARD");
    ...
    protected void createAndShowGUI() {
        ...
        this.modifyProfil.addActionListener(mainView.getController());
        this.deleteProfil.addActionListener(mainView.getController());
        this.comeback.addActionListener(mainView.getController());

        this.modifyProfil.setEnabled(false);
        this.deleteProfil.setEnabled(false);

        this.modifyProfil.setActionCommand("MODIFYVCARDADDMODIFYVIEW2");
        this.deleteProfil.setActionCommand("REMOVEPROFILADDMODIFYVIEW2");
        this.comeback.setActionCommand("COMEBACKTOADDMODIFYVIEW2");
        ...
        this.modifyProfil.setPreferredSize(new Dimension(250, 50));
        this.deleteProfil.setPreferredSize(new Dimension(250, 50));
        ...
        this.listProfilList.addListSelectionListener(new ListSelectionListener() {
            ...
            public void valueChanged(ListSelectionEvent evt) {
                ...
                if(list.getSelectedValue()==null) {
                    modifyProfil.setEnabled(false);
                    deleteProfil.setEnabled(false);
                }else {
                    modifyProfil.setEnabled(true);
                    deleteProfil.setEnabled(true);
        ...
        this.headerPanel.add(modifyProfil);
        this.headerPanel.add(deleteProfil);
