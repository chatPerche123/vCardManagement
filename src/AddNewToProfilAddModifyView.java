...
public class AddNewToProfilAddModifyView extends JDialog {
    ...
    public AddNewToProfilAddModifyView(MainView mainView) {
        ...
        formListElement = new Object[]{/*vcardFormatCombo, */familyNameTxt, givenNameTxt, prefixesTxt, suffixesTxt, additionalNameTxt,
        ...
        //buttonsNorthPanel.setBackground(new java.awt.Color(51, 255, 51));
        middleFormPanel.getViewport().setBackground(new java.awt.Color(102, 255, 255));
        //buttonSouthPanel.setBackground(new java.awt.Color(204, 204, 255));
    }
    ...
    protected void createAndShowGUI() throws IOException {
        ...
        this.setSelectedVcard(mainView.getAddModifyView().selectedVcard);
        this.setCombo();
        ...
        saveInformation.setActionCommand("SAVEADDNEWADDMODIFYVIEW2");
        leave.setActionCommand("LEAVEADDNEWADDMODIFYVIEW2");
        reset.setActionCommand("RESETADDNEWADDMODIFYVIEW2");
    ...
    /*Retrieve my SELECTED PROFIL then add to a Map<Object, boolean> where Object are form components.
    => false:  my profil already have this information
    => true:   my profil can have multiple time the same information or that i don't already have it
        Exemple, i can't have more than one given name but can have multiple address.
    Then accessForm() will check this Map and give access to the user the correct form accordingly to the profil selected
     */
    protected void checkInfo() {
        vCardProfilFormSelected = new VCard(mainView.getAddModifyView().selectedProfil);
        ...
        if(vCardProfilFormSelected.getStructuredNames().isEmpty()) {
            ...
            vCardProfilFormSelected.setStructuredName(new StructuredName());
        }

        for (StructuredName sn : vCardProfilFormSelected.getStructuredNames()) {
            if (sn.getFamily() != null) {
                //System.out.println("Family name pas null");
            ...
            if (sn.getGiven() != null) {
                //System.out.println("Givenname pas null");
                mapFormBool.put(givenNameTxt, true);
            } else {
                //System.out.println("Givenname null");
                mapFormBool.put(givenNameTxt, false);
            }
        ...
        mapFormBool.put(addressTypeComboBox, false);mapFormBool.put(addressTypeComboBox2, false);mapFormBool.put(addressTypeComboBox3, false);
        mapFormBool.put(streetNameTxt, false);mapFormBool.put(streetNameTxt2, false);mapFormBool.put(streetNameTxt3, false);
        mapFormBool.put(cityNameTxt, false);mapFormBool.put(cityNameTxt2, false);mapFormBool.put(cityNameTxt3, false);
        mapFormBool.put(regionNameTxt, false);mapFormBool.put(regionNameTxt2, false);mapFormBool.put(regionNameTxt3, false);
        mapFormBool.put(postalCodeNameTxt, false);mapFormBool.put(postalCodeNameTxt2, false);mapFormBool.put(postalCodeNameTxt3, false);
        mapFormBool.put(countryNameTxt, false);mapFormBool.put(countryNameTxt, false);mapFormBool.put(countryNameTxt, false);

        mapFormBool.put(mobilNumberTxt, false);
        mapFormBool.put(workNumberTxt, false);
        mapFormBool.put(homeNumberTxt, false);

        mapFormBool.put(personalMailTxt, false);
        mapFormBool.put(proMailTxt, false);
        mapFormBool.put(otherMailTxt, false);


        if(!vCardProfilFormSelected.getOrganizations().toString().equals("[]")) {
        ...
        mapFormBool.put(url1Txt, false);
        mapFormBool.put(url2Txt, false);
        mapFormBool.put(url3Txt, false);
        ...
        if(vCardProfilFormSelected.getVersion().toString().equals("4.0")) {
            //System.out.println("C EST UN 4.0");
            Birthplace b = vCardProfilFormSelected.getBirthplace();
            if(b != null) {
                mapFormBool.put(birthPlaceTxt, true);
            }else {
